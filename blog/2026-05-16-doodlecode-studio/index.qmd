...
I built this project in collaboration with AI coding assistants. I drove the design — the canvas model, the file-format contract, the presenter-mode UX, what got cut. AI helped me move faster through the React Flow + Zustand glue, the FastAPI / `jupyter_client` plumbing, and the tedious bits of TypeScript types and tests. I'm calling that out up front because I think being explicit about how we use these tools is going to matter more, not less, over the next few years.
:::
...
MIT-licensed, **Co-AI Developed**, and built in the open. If you've got opinions on the file format or feature requests, the issues tab is the right place.
