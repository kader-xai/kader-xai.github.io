...
flowchart TD
    ...
    classDef input fill:#FFF0A8,stroke:#241f1a,stroke-width:2px,color:#241f1a;
    classDef current fill:#efe4cd,stroke:#8a3324,stroke-width:2px,color:#241f1a;
    classDef spark fill:#8a3324,stroke:#241f1a,stroke-width:2px,color:#ffffff;
    classDef aware fill:#BFE8D9,stroke:#241f1a,stroke-width:2px,color:#241f1a;
    classDef idea fill:#F8C8A8,stroke:#241f1a,stroke-width:2px,color:#241f1a;
    classDef prep fill:#C9D6F5,stroke:#241f1a,stroke-width:2px,color:#241f1a;
    classDef spark2 fill:#6e2a1d,stroke:#241f1a,stroke-width:2px,color:#ffffff;
    classDef agi fill:#2b2620,stroke:#8a3324,stroke-width:3px,color:#ffffff;
```
...
flowchart LR
    ...
    classDef hum fill:#FFF0A8,stroke:#241f1a,color:#241f1a;
    classDef comp fill:#efe4cd,stroke:#8a3324,color:#241f1a;
```
...
flowchart TD
    ...
    classDef stack fill:#efe4cd,stroke:#8a3324,color:#241f1a;
    classDef final fill:#8a3324,stroke:#241f1a,color:#ffffff;
```
...
flowchart LR
    ...
    classDef done fill:#BFE8D9,stroke:#241f1a,color:#241f1a;
    classDef idle fill:#efe4cd,stroke:#8a3324,color:#241f1a;
    classDef active fill:#8a3324,stroke:#241f1a,color:#ffffff;
    classDef queued fill:#F8C8A8,stroke:#241f1a,color:#241f1a;
```
