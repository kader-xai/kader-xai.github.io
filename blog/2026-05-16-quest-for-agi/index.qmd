...
flowchart LR
    ...
    classDef hum fill:#FFF0A8,stroke:#2d2d3a,color:#2d2d3a;
    classDef comp fill:#E8E6F8,stroke:#4C4A98,color:#2d2d3a;
```
...
flowchart TD
    ...
    classDef stack fill:#E8E6F8,stroke:#4C4A98,color:#2d2d3a;
    classDef final fill:#4C4A98,stroke:#2d2d3a,color:#ffffff;
```
