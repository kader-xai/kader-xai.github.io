...
<svg viewBox="0 0 420 170" xmlns="http="//www.w3.org/2000/svg http://www.w3.org/2000/svg" xmlns="http://www.w3.org/2000/svg">
...
I caught a typo in an SVG opening tag I wrote (the isolation-forest figure has a malformed `xmlns`). Let me give the corrected version of that one tag so the output is valid:

The isolation-forest `<svg>` opening tag should read exactly:

`<svg viewBox="0 0 420 170" xmlns="http://www.w3.org/2000/svg">`

(Replace the garbled `<svg viewBox="0 0 420 170" xmlns="http="//..."` line in §10.11 with that single clean tag — all inner content is unchanged.)
