...
<style>
@keyframes c35-dial-slide { 0%,100% { cx: 110px; } 50% { cx: 270px; } }
@keyframes c35-dial-fade  { 0%,100% { opacity: .35; } 50% { opacity: 1; } }
.c35-dial-knob { animation: c35-dial-slide 7s ease-in-out infinite; }
.c35-dial-ex   { animation: c35-dial-fade  7s ease-in-out infinite; }
.c35-dial-ix   { animation: c35-dial-fade  7s ease-in-out infinite reverse; }
@media (prefers-reduced-motion: reduce) {
  .c35-dial-knob, .c35-dial-ex, .c35-dial-ix { animation: none; }
}
</style>
<svg viewBox="0 0 380 90" xmlns="http://www.w3.org/2000/svg" font-family="sans-serif" font-size="12" role="img" aria-label="A knob sliding back and forth between explore and exploit.">
  <rect x="40" y="44" width="300" height="8" rx="4" fill="#6366f1" opacity="0.25"/>
  <text x="40" y="74" fill="#38bdf8" text-anchor="middle" class="c35-dial-ex" font-size="11">explore</text>
  <text x="340" y="74" fill="#f59e0b" text-anchor="middle" class="c35-dial-ix" font-size="11">exploit</text>
  <text x="190" y="26" fill="currentColor" text-anchor="middle" font-size="11">over time, every method slides this knob</text>
  <circle cx="110" cy="48" r="9" fill="#a855f7" class="c35-dial-knob"/>
</svg>
...
<style>
@keyframes c35-bit-fill { 0%,30% { fill: #6366f1; opacity: .3; } 70%,100% { fill: #22c55e; opacity: .95; } }
.c35-bit { animation: c35-bit-fill 6s ease-in-out infinite; }
@media (prefers-reduced-motion: reduce) { .c35-bit { animation: none; fill: #22c55e; opacity: .95; } }
</style>
<svg viewBox="0 0 360 92" xmlns="http://www.w3.org/2000/svg" font-family="sans-serif" font-size="11" role="img" aria-label="A grid of bits flipping from random to all-ones as generations pass.">
  <text x="14" y="16" fill="currentColor" font-size="11">population of 8-bit strings, generation by generation →</text>
  <!-- 4 rows × 8 cells; staggered delays make a wave of 0s turning into 1s -->
  <g>
    <rect class="c35-bit" x="20"  y="28" width="18" height="14" rx="2" style="animation-delay:.0s"/>
    <rect class="c35-bit" x="42"  y="28" width="18" height="14" rx="2" style="animation-delay:.4s"/>
    <rect class="c35-bit" x="64"  y="28" width="18" height="14" rx="2" style="animation-delay:.8s"/>
    <rect class="c35-bit" x="86"  y="28" width="18" height="14" rx="2" style="animation-delay:1.2s"/>
    <rect class="c35-bit" x="108" y="28" width="18" height="14" rx="2" style="animation-delay:.6s"/>
    <rect class="c35-bit" x="130" y="28" width="18" height="14" rx="2" style="animation-delay:1.0s"/>
    <rect class="c35-bit" x="152" y="28" width="18" height="14" rx="2" style="animation-delay:.2s"/>
    <rect class="c35-bit" x="174" y="28" width="18" height="14" rx="2" style="animation-delay:1.4s"/>
  </g>
  <g>
    <rect class="c35-bit" x="20"  y="46" width="18" height="14" rx="2" style="animation-delay:1.1s"/>
    <rect class="c35-bit" x="42"  y="46" width="18" height="14" rx="2" style="animation-delay:.3s"/>
    <rect class="c35-bit" x="64"  y="46" width="18" height="14" rx="2" style="animation-delay:.9s"/>
    <rect class="c35-bit" x="86"  y="46" width="18" height="14" rx="2" style="animation-delay:1.5s"/>
    <rect class="c35-bit" x="108" y="46" width="18" height="14" rx="2" style="animation-delay:.5s"/>
    <rect class="c35-bit" x="130" y="46" width="18" height="14" rx="2" style="animation-delay:.1s"/>
    <rect class="c35-bit" x="152" y="46" width="18" height="14" rx="2" style="animation-delay:1.3s"/>
    <rect class="c35-bit" x="174" y="46" width="18" height="14" rx="2" style="animation-delay:.7s"/>
  </g>
  <g>
    <rect class="c35-bit" x="20"  y="64" width="18" height="14" rx="2" style="animation-delay:.7s"/>
    <rect class="c35-bit" x="42"  y="64" width="18" height="14" rx="2" style="animation-delay:1.2s"/>
    <rect class="c35-bit" x="64"  y="64" width="18" height="14" rx="2" style="animation-delay:.2s"/>
    <rect class="c35-bit" x="86"  y="64" width="18" height="14" rx="2" style="animation-delay:.9s"/>
    <rect class="c35-bit" x="108" y="64" width="18" height="14" rx="2" style="animation-delay:1.5s"/>
    <rect class="c35-bit" x="130" y="64" width="18" height="14" rx="2" style="animation-delay:.4s"/>
    <rect class="c35-bit" x="152" y="64" width="18" height="14" rx="2" style="animation-delay:1.0s"/>
    <rect class="c35-bit" x="174" y="64" width="18" height="14" rx="2" style="animation-delay:.6s"/>
  </g>
  <text x="210" y="58" fill="#22c55e" font-size="12">all-1s = fitness 8 ✓</text>
</svg>
...
<svg viewBox="0 0 320 150" xmlns="http://www.w3.org/2000/svg" font-family="sans-serif" font-size="11" role="img" aria-label="A pie chart of four roulette slices proportional to fitness 6, 3, 1, 0.">
  <!-- wheel centred at (90,80) r=60; slices: 0.6, 0.3, 0.1, 0.0 of 360deg -->
  <!-- slice 1: 0..216deg  (fitness 6) -->
  <path d="M90,80 L150,80 A60,60 0 0,1 41.5,128.5 Z" fill="#6366f1" opacity="0.85"/>
  <!-- slice 2: 216..324deg (fitness 3) -->
  <path d="M90,80 L41.5,128.5 A60,60 0 0,1 41.5,31.5 Z" fill="#22c55e" opacity="0.85"/>
  <!-- slice 3: 324..360deg (fitness 1) -->
  <path d="M90,80 L41.5,31.5 A60,60 0 0,1 76.1,21.6 Z" fill="#f59e0b" opacity="0.85"/>
  <circle cx="90" cy="80" r="60" fill="none" stroke="currentColor" stroke-width="1.5"/>
  <text x="105" y="105" fill="#fff" font-size="11">f=6</text>
  <text x="40" y="78" fill="#fff" font-size="11">f=3</text>
  <text x="62" y="40" fill="#fff" font-size="10">f=1</text>
  <g font-size="11">
    <rect x="190" y="40" width="12" height="12" fill="#6366f1" opacity="0.85"/><text x="208" y="50" fill="currentColor">f=6 → 0.60</text>
    <rect x="190" y="60" width="12" height="12" fill="#22c55e" opacity="0.85"/><text x="208" y="70" fill="currentColor">f=3 → 0.30</text>
    <rect x="190" y="80" width="12" height="12" fill="#f59e0b" opacity="0.85"/><text x="208" y="90" fill="currentColor">f=1 → 0.10</text>
    <rect x="190" y="100" width="12" height="12" fill="none" stroke="currentColor"/><text x="208" y="110" fill="currentColor">f=0 → 0.00</text>
  </g>
</svg>
...
<svg viewBox="0 0 380 150" xmlns="http://www.w3.org/2000/svg" font-family="sans-serif" font-size="11" role="img" aria-label="Two parent trees swap a highlighted subtree to make a child tree.">
  <!-- parent 1 -->
  <text x="50" y="16" fill="currentColor">parent A</text>
  <line x1="50" y1="28" x2="30" y2="58" stroke="#888"/><line x1="50" y1="28" x2="70" y2="58" stroke="#888"/>
  <circle cx="50" cy="26" r="9" fill="#4e79a7"/><text x="50" y="30" fill="#fff" text-anchor="middle">+</text>
  <circle cx="30" cy="64" r="9" fill="#e15759"/><text x="30" y="68" fill="#fff" text-anchor="middle">x</text>
  <circle cx="70" cy="64" r="11" fill="#a855f7" opacity="0.85"/><text x="70" y="68" fill="#fff" text-anchor="middle" font-size="9">×</text>
  <text x="62" y="86" fill="#a855f7" font-size="9">swap ↓</text>
  <!-- parent 2 -->
  <text x="170" y="16" fill="currentColor">parent B</text>
  <line x1="170" y1="28" x2="150" y2="58" stroke="#888"/><line x1="170" y1="28" x2="190" y2="58" stroke="#888"/>
  <circle cx="170" cy="26" r="9" fill="#59a14f"/><text x="170" y="30" fill="#fff" text-anchor="middle">+</text>
  <circle cx="150" cy="64" r="11" fill="#22c55e" opacity="0.85"/><text x="150" y="68" fill="#fff" text-anchor="middle" font-size="9">sin</text>
  <circle cx="190" cy="64" r="9" fill="#e15759"/><text x="190" y="68" fill="#fff" text-anchor="middle">x</text>
  <text x="140" y="86" fill="#22c55e" font-size="9">swap ↓</text>
  <!-- arrow -->
  <line x1="230" y1="55" x2="270" y2="55" stroke="currentColor" stroke-width="1.5" marker-end="url(#c35gp)"/>
  <defs><marker id="c35gp" markerWidth="8" markerHeight="8" refX="6" refY="3" orient="auto"><path d="M0,0 L6,3 L0,6 Z" fill="currentColor"/></marker></defs>
  <!-- child -->
  <text x="320" y="16" fill="currentColor">child</text>
  <line x1="320" y1="28" x2="300" y2="58" stroke="#888"/><line x1="320" y1="28" x2="340" y2="58" stroke="#888"/>
  <circle cx="320" cy="26" r="9" fill="#4e79a7"/><text x="320" y="30" fill="#fff" text-anchor="middle">+</text>
  <circle cx="300" cy="64" r="9" fill="#e15759"/><text x="300" y="68" fill="#fff" text-anchor="middle">x</text>
  <circle cx="340" cy="64" r="11" fill="#22c55e" opacity="0.85"/><text x="340" y="68" fill="#fff" text-anchor="middle" font-size="9">sin</text>
  <text x="250" y="120" fill="#666" font-size="10">A keeps its left branch, but borrows B's subtree on the right</text>
</svg>
...
<style>
@keyframes c35-sigma-pulse { 0%,100% { r: 26px; opacity: .30; } 50% { r: 40px; opacity: .12; } }
@keyframes c35-sigma-dot   { 0%,100% { cy: 70px; } 50% { cy: 52px; } }
.c35-sigma-ring { animation: c35-sigma-pulse 5s ease-in-out infinite; }
.c35-sigma-dot  { animation: c35-sigma-dot 5s ease-in-out infinite; }
@media (prefers-reduced-motion: reduce) { .c35-sigma-ring, .c35-sigma-dot { animation: none; } }
</style>
<svg viewBox="0 0 340 140" xmlns="http://www.w3.org/2000/svg" font-family="sans-serif" font-size="11" role="img" aria-label="A mutation cloud that breathes wider when successes are plentiful and tighter when they are scarce.">
  <circle cx="80" cy="70" r="30" class="c35-sigma-ring" fill="#6366f1"/>
  <circle cx="80" cy="70" r="4" fill="#a855f7"/>
  <circle cx="80" class="c35-sigma-dot" r="3" fill="#22c55e"/>
  <text x="80" y="120" fill="currentColor" text-anchor="middle" font-size="10">step size σ breathes</text>
  <text x="170" y="50" fill="#22c55e" font-size="11">&gt; 1/5 succeed → grow σ (explore faster)</text>
  <text x="170" y="92" fill="#f59e0b" font-size="11">&lt; 1/5 succeed → shrink σ (refine)</text>
</svg>
...
<style>
@keyframes c35-vote-up   { 0%,100% { opacity: .3; } 50% { opacity: 1; } }
.c35-vote-up { animation: c35-vote-up 4.5s ease-in-out infinite; }
@media (prefers-reduced-motion: reduce) { .c35-vote-up { animation: none; opacity: 1; } }
</style>
<svg viewBox="0 0 320 130" xmlns="http://www.w3.org/2000/svg" font-family="sans-serif" font-size="11" role="img" aria-label="Random arrows radiating from a center; the uphill ones glow, and their resultant points uphill.">
  <circle cx="120" cy="80" r="5" fill="#a855f7"/>
  <!-- random probe arrows; uphill (rightward/up) ones pulse bright -->
  <g stroke="#94a3b8" stroke-width="1.5" fill="none">
    <line x1="120" y1="80" x2="80"  y2="60"/>
    <line x1="120" y1="80" x2="95"  y2="110"/>
    <line x1="120" y1="80" x2="130" y2="115"/>
  </g>
  <g stroke="#22c55e" stroke-width="2.5" fill="none" class="c35-vote-up">
    <line x1="120" y1="80" x2="165" y2="50"/>
    <line x1="120" y1="80" x2="175" y2="68"/>
    <line x1="120" y1="80" x2="150" y2="40"/>
  </g>
  <!-- resultant uphill vector -->
  <line x1="120" y1="80" x2="230" y2="45" stroke="#f59e0b" stroke-width="3.5" marker-end="url(#c35up)"/>
  <defs><marker id="c35up" markerWidth="9" markerHeight="9" refX="6" refY="3" orient="auto">
    <path d="M0,0 L7,3 L0,6 Z" fill="#f59e0b"/></marker></defs>
  <text x="236" y="42" fill="#f59e0b">estimated uphill</text>
  <text x="60" y="124" fill="#22c55e">green probes raised reward → they vote</text>
</svg>
...
<svg viewBox="0 0 340 160" xmlns="http://www.w3.org/2000/svg" font-family="sans-serif" font-size="11" role="img" aria-label="A particle's new velocity built from inertia, cognitive, and social vector pulls.">
  <circle cx="70" cy="110" r="5" fill="#a855f7"/><text x="40" y="128" fill="currentColor">particle</text>
  <!-- inertia (keep cruising) -->
  <line x1="70" y1="110" x2="130" y2="100" stroke="#6366f1" stroke-width="2.5" marker-end="url(#c35pi)"/>
  <text x="98" y="92" fill="#6366f1" font-size="10">inertia</text>
  <!-- cognitive toward personal best -->
  <line x1="70" y1="110" x2="105" y2="60" stroke="#22c55e" stroke-width="2.5" marker-end="url(#c35pc)"/>
  <text x="40" y="62" fill="#22c55e" font-size="10">cognitive (self best)</text>
  <!-- social toward global best -->
  <line x1="70" y1="110" x2="150" y2="135" stroke="#f59e0b" stroke-width="2.5" marker-end="url(#c35ps)"/>
  <text x="150" y="150" fill="#f59e0b" font-size="10">social (swarm best)</text>
  <!-- resultant -->
  <line x1="70" y1="110" x2="190" y2="78" stroke="#ec4899" stroke-width="3" stroke-dasharray="5 3" marker-end="url(#c35pr)"/>
  <text x="196" y="76" fill="#ec4899" font-size="10">new velocity</text>
  <defs>
    <marker id="c35pi" markerWidth="8" markerHeight="8" refX="6" refY="3" orient="auto"><path d="M0,0 L6,3 L0,6 Z" fill="#6366f1"/></marker>
    <marker id="c35pc" markerWidth="8" markerHeight="8" refX="6" refY="3" orient="auto"><path d="M0,0 L6,3 L0,6 Z" fill="#22c55e"/></marker>
    <marker id="c35ps" markerWidth="8" markerHeight="8" refX="6" refY="3" orient="auto"><path d="M0,0 L6,3 L0,6 Z" fill="#f59e0b"/></marker>
    <marker id="c35pr" markerWidth="8" markerHeight="8" refX="6" refY="3" orient="auto"><path d="M0,0 L6,3 L0,6 Z" fill="#ec4899"/></marker>
  </defs>
</svg>
...
**Ant Colony Optimization (ACO)** solves *combinatorial* problems — classically the Traveling Salesman Problem (the kind of constraint-laden combinatorial search covered in [Planning, CSP & Game Playing](ch34.html)) — by imitating how ants find short paths using **pheromone**. Each artificial ant builds a tour, choosing the next city probabilistically from a blend of the **pheromone** $\tau$ on an edge (learned desirability) and a **heuristic** $\eta = 1/\text{distance}$ (greedy nearness):

$$P(i \to j) \;=\; \frac{\tau_{ij}^{\alpha}\,\eta_{ij}^{\beta}}{\sum_{k \in \text{allowed}} \tau_{ik}^{\alpha}\,\eta_{ik}^{\beta}}$$

**In words:** the chance an ant at city $i$ steps to city $j$ is the "attractiveness" of edge $i\!\to\!j$ (its pheromone raised to power $\alpha$, times its nearness raised to power $\beta$) divided by the summed attractiveness of every city the ant could still go to — so it's a [softmax](ch14.html) over edge desirability.
...
<style>
@keyframes c35-sa-ball {
  0%   { offset-distance: 0%;   }
  35%  { offset-distance: 38%;  }  /* jiggles past the local min while hot */
  55%  { offset-distance: 30%;  }
  100% { offset-distance: 100%; }   /* settles in the deep basin once cold */
}
@keyframes c35-sa-temp { 0% { fill: #ec4899; } 100% { fill: #38bdf8; } }
.c35-sa-ball {
  offset-path: path("M10,120 Q70,40 110,110 T210,70 T320,30");
  animation: c35-sa-ball 8s cubic-bezier(.5,0,.5,1) infinite;
}
.c35-sa-tchip { animation: c35-sa-temp 8s linear infinite; }
@media (prefers-reduced-motion: reduce) { .c35-sa-ball { animation: none; offset-distance: 100%; } }
</style>
<svg viewBox="0 0 340 150" xmlns="http://www.w3.org/2000/svg" font-family="sans-serif" font-size="11" role="img" aria-label="A ball jiggling over a bumpy curve while hot, then settling into the deepest valley as it cools.">
  <path d="M10,120 Q70,40 110,110 T210,70 T320,30" fill="none" stroke="#6366f1" stroke-width="2"/>
  <circle cx="110" cy="110" r="4" fill="#888"/><text x="80" y="135" fill="#888" font-size="10">local min</text>
  <circle cx="300" cy="35" r="4" fill="#22c55e"/><text x="255" y="26" fill="#22c55e" font-size="10">global min</text>
  <rect x="14" y="10" width="58" height="16" rx="8" class="c35-sa-tchip" opacity="0.85"/>
  <text x="43" y="22" fill="#fff" text-anchor="middle" font-size="10">hot → cold</text>
  <circle r="6" fill="#f59e0b" class="c35-sa-ball"/>
</svg>
...
<style>
@keyframes c35-fz-flow { 0% { stroke-dashoffset: 40; } 100% { stroke-dashoffset: 0; } }
@keyframes c35-fz-pulse { 0%,100% { opacity: .5; } 50% { opacity: 1; } }
.c35-fz-wire { stroke-dasharray: 6 4; animation: c35-fz-flow 1.6s linear infinite; }
.c35-fz-box  { animation: c35-fz-pulse 4s ease-in-out infinite; }
@media (prefers-reduced-motion: reduce) { .c35-fz-wire, .c35-fz-box { animation: none; } }
</style>
<svg viewBox="0 0 380 110" xmlns="http://www.w3.org/2000/svg" font-family="sans-serif" font-size="10" role="img" aria-label="A pipeline: crisp 28 degrees enters, becomes fuzzy, rules fire, defuzzify, crisp fan speed exits.">
  <text x="20" y="55" fill="currentColor" text-anchor="middle">28°C</text>
  <line x1="38" y1="50" x2="70" y2="50" stroke="#38bdf8" stroke-width="2" class="c35-fz-wire"/>
  <rect x="70" y="34" width="66" height="32" rx="5" fill="#6366f1" class="c35-fz-box" opacity="0.7"/>
  <text x="103" y="54" fill="#fff" text-anchor="middle">fuzzify</text>
  <line x1="136" y1="50" x2="160" y2="50" stroke="#38bdf8" stroke-width="2" class="c35-fz-wire"/>
  <rect x="160" y="34" width="66" height="32" rx="5" fill="#a855f7" class="c35-fz-box" opacity="0.7" style="animation-delay:.6s"/>
  <text x="193" y="50" fill="#fff" text-anchor="middle">rules</text>
  <text x="193" y="60" fill="#fff" text-anchor="middle" font-size="8">IF–THEN</text>
  <line x1="226" y1="50" x2="250" y2="50" stroke="#38bdf8" stroke-width="2" class="c35-fz-wire"/>
  <rect x="250" y="34" width="74" height="32" rx="5" fill="#22c55e" class="c35-fz-box" opacity="0.7" style="animation-delay:1.2s"/>
  <text x="287" y="54" fill="#fff" text-anchor="middle">defuzzify</text>
  <line x1="324" y1="50" x2="352" y2="50" stroke="#f59e0b" stroke-width="2" class="c35-fz-wire"/>
  <text x="365" y="55" fill="#f59e0b" text-anchor="middle">65%</text>
  <text x="190" y="22" fill="currentColor" text-anchor="middle" font-size="10">crisp in → fuzzy → crisp out</text>
</svg>
...
|---|---|---|
| Explore ↔ exploit | The single dial: wander widely vs. refine the current best | The lens for understanding *every* method here |
...
- **[Calculus & Differentiation](ch02.html)** — why differentiability is the dividing line that sends you to gradient methods or metaheuristics.
- **[Search & Problem Solving](ch32.html)** — classical and heuristic search (A*, hill-climbing) that trajectory-based metaheuristics generalize.
...
::: {.callout-note appearance="simple"}
**↪ The thread continues → [Chapter 36 · 🔍 Explainable AI & Interpretability](ch36.html)**
