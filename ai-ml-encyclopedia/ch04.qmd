...
<svg viewBox="0 0 360 150" xmlns="http://www.w3.org/2000/svg" font-family="sans-serif" font-size="11" role="img" aria-label="Entropy curve peaking at one bit for a fair coin and dropping to zero at the certain extremes.">
  ...
  <text x="160" y="-2" fill="currentColor"> </text>
