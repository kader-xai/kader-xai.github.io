...
**In words:** shallow levels get re-expanded once per remaining round, but because each deeper level is $b$ times bigger, the bottom level swamps all the repeats — the total is only a constant factor more than a single BFS sweep.
