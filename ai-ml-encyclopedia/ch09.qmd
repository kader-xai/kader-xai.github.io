...
- **Calibration** is confidence honesty, separate from accuracy; SVMs and NB are miscalibrated — fix with Platt scaling or isotonic regression on held-out data.
...
- **Model Evaluation & Tuning** — cross-validation for choosing $k$, $C$, $\gamma$, and tree depth; precision/recall, ROC-AUC, log loss, and reliability diagrams.
