...
**Also written:** as a belief divided by the back-message, $m_{i\to j} = \big(\sum_{C_i\setminus S}\text{belief}(C_i)\big) / m_{j\to i}$ — the Hugin "absorb" form, which avoids recomputing the product from scratch.
