...
**Also written:** $\text{PSI} = \sum_i a_i \ln\frac{a_i}{e_i} + \sum_i e_i \ln\frac{e_i}{a_i} = D_{\mathrm{KL}}(a\Vert e) + D_{\mathrm{KL}}(e\Vert a)$ — PSI is exactly the *symmetric* (Jeffreys) KL divergence between the live and training histograms.
...
## 29.9 — Cost, efficiency & the FinOps of serving
...
## 29.10 — Security, governance & responsible deployment
...
- **Inference dominates lifetime cost**; close the reserved-vs-used gap with right-sizing, **dynamic batching**, autoscale-to-zero, and quantization, and track **cost per 1,000 predictions** as a first-class metric.
