...
flowchart LR
    ...
    D --> F[Aligned model]
    E --> F
    F -.->|harder tasks:<br/>verifiable reward| G[RL for reasoning<br/>see 23.11]
```
...
## 23.13 — Multimodal LLMs (vision-language models)
...
- A **vision encoder** (usually a Vision Transformer, often the image half of a **CLIP** model) cuts the image into patches and turns each into a vector — *visual tokens*.
...
## 23.14 — Long context and context engineering
