...
High-dimensional data is hard to store, slow to train on, noisy, and impossible to picture. **Dimensionality reduction** is the craft of squeezing many features down to a handful of well-chosen ones while throwing away as little useful structure as possible. It sits at the end of the ML workflow's data-shaping stage — after [preprocessing](ch06.html), before modeling — and pays off in faster training, less [overfitting](ch12.html), denoised signals, and 2-D pictures you can actually look at.
...
<style>
@keyframes c7-shell-grow { 0%,100% { r: 56px; } 50% { r: 20px; } }
@keyframes c7-shell-label { 0%,100% { opacity:0.4; } 50% { opacity:1; } }
@media (prefers-reduced-motion: reduce){ .c7-core{ animation:none !important; } }
</style>
<svg viewBox="0 0 380 150" xmlns="http://www.w3.org/2000/svg" font-family="sans-serif" font-size="11">
  <text x="10" y="16" fill="currentColor">As D grows, almost all volume moves to the outer shell</text>
  <circle cx="90" cy="90" r="62" fill="rgba(236,72,153,0.30)" stroke="#ec4899"/>
  <circle class="c7-core" cx="90" cy="90" r="56" fill="rgba(99,102,241,0.55)" style="animation: c7-shell-grow 5s ease-in-out infinite;"/>
  <text x="60" y="94" fill="currentColor" font-size="9">core</text>
  <text x="118" y="60" fill="#ec4899" font-size="9" style="animation: c7-shell-label 5s ease-in-out infinite;">shell</text>
  <text x="195" y="86" fill="currentColor">low D ⇄ high D:</text>
  <text x="195" y="104" fill="currentColor">the middle empties out,</text>
  <text x="195" y="120" fill="currentColor">points crowd the edge.</text>
</svg>
...
<svg viewBox="0 0 360 220" xmlns="http://www.w3.org/2000/svg" font-family="sans-serif" font-size="11">
  ...
  <circle cx="135" cy="150" r="4" fill="currentColor"/>
  <circle cx="180" cy="120" r="4" fill="currentColor"/>
  <circle cx="225" cy="90" r="4" fill="currentColor"/>
  ...
  <text x="40" y="35" fill="currentColor">Dark: data · Blue: projection onto PC1</text>
</svg>

**Link to SVD.** In practice nobody forms $\Sigma$ explicitly — it is numerically wasteful and can lose precision. Instead use the **[Singular Value Decomposition](ch01.html)** of the centered data matrix $X$ (rows = samples):
...
<svg viewBox="0 0 360 180" xmlns="http://www.w3.org/2000/svg" font-family="sans-serif" font-size="10">
  ...
  <text x="150" y="165" fill="currentColor">component index</text>
  <text x="8" y="80" fill="currentColor" transform="rotate(-90 8,80)">variance</text>
  <!-- scree bars -->
...
<svg viewBox="0 0 420 200" xmlns="http://www.w3.org/2000/svg" font-family="sans-serif" font-size="11">
  ...
  <text x="40" y="18" fill="currentColor">Swiss roll in 3-D (rolled)</text>
  ...
  <text x="60" y="180" fill="currentColor" opacity="0.6">A,B near in 3-D…</text>
  <!-- arrow -->
  <line x1="195" y1="100" x2="245" y2="100" stroke="currentColor" stroke-width="1.5" marker-end="url(#ar)"/>
  ...
  <text x="198" y="92" fill="currentColor">unroll</text>
  <!-- unrolled flat sheet (right) -->
  <text x="280" y="18" fill="currentColor">unrolled (2-D)</text>
  ...
  <text x="285" y="180" fill="currentColor" opacity="0.6">…but far apart on the sheet</text>
</svg>
...
<svg viewBox="0 0 360 200" xmlns="http://www.w3.org/2000/svg" font-family="sans-serif" font-size="10">
  ...
  <text x="252" y="48" fill="currentColor" opacity="0.6">PCA</text>
  <text x="40" y="185" fill="currentColor">LDA aims the axis to pull class means apart; PCA only follows total variance.</text>
</svg>
...
<style>
@keyframes c7-tsne-a { 0% { transform: translate(0,0); } 100% { transform: translate(118px,-6px); } }
@keyframes c7-tsne-b { 0% { transform: translate(0,0); } 100% { transform: translate(120px,4px); } }
@keyframes c7-tsne-c { 0% { transform: translate(0,0); } 100% { transform: translate(150px,2px); } }
@media (prefers-reduced-motion: reduce){ .c7-tp{ animation:none !important; } }
.c7-tp { animation-duration: 5s; animation-timing-function: ease-in-out; animation-iteration-count: infinite; animation-direction: alternate; }
</style>
<svg viewBox="0 0 380 160" xmlns="http://www.w3.org/2000/svg" font-family="sans-serif" font-size="10">
  <text x="14" y="14" fill="currentColor">scattered in high-D</text>
  <text x="250" y="14" fill="currentColor">grouped in 2-D</text>
  <line x1="190" y1="24" x2="190" y2="150" stroke="currentColor" opacity="0.3" stroke-dasharray="3 3"/>
  <!-- cluster 1 (indigo) -->
  <circle class="c7-tp" cx="40"  cy="40"  r="5" fill="#6366f1" style="animation-name:c7-tsne-a;"/>
  <circle class="c7-tp" cx="150" cy="120" r="5" fill="#6366f1" style="animation-name:c7-tsne-b;"/>
  <circle class="c7-tp" cx="30"  cy="120" r="5" fill="#6366f1" style="animation-name:c7-tsne-c;"/>
  <!-- cluster 2 (green) -->
  <circle class="c7-tp" cx="120" cy="40"  r="5" fill="#22c55e" style="animation-name:c7-tsne-c;"/>
  <circle class="c7-tp" cx="60"  cy="80"  r="5" fill="#22c55e" style="animation-name:c7-tsne-b;"/>
  <circle class="c7-tp" cx="160" cy="70"  r="5" fill="#22c55e" style="animation-name:c7-tsne-a;"/>
  <text x="250" y="86" fill="currentColor">same colors</text>
  <text x="250" y="102" fill="currentColor">end up adjacent →</text>
</svg>
...
<svg viewBox="0 0 380 200" xmlns="http://www.w3.org/2000/svg" font-family="sans-serif" font-size="10">
  <text x="20" y="18" fill="currentColor">2 sources</text>
  <text x="150" y="18" fill="currentColor">mics: blends of both</text>
  <text x="300" y="18" fill="currentColor">ICA recovers</text>
  <!-- source 1: sine -->
...
<style>
@keyframes c7-ae-flow { 0% { offset-distance: 0%; opacity:0; } 10% { opacity:1; } 90% { opacity:1; } 100% { offset-distance: 100%; opacity:0; } }
@keyframes c7-ae-pulse { 0%,100% { r: 7px; opacity:0.6; } 50% { r: 11px; opacity:1; } }
@media (prefers-reduced-motion: reduce){ .c7-pkt,.c7-neck{ animation:none !important; } }
</style>
<svg viewBox="0 0 380 150" xmlns="http://www.w3.org/2000/svg" font-family="sans-serif" font-size="10">
  <text x="10" y="14" fill="currentColor">data squeezed through the bottleneck, then rebuilt</text>
  <polygon points="30,40 170,68 170,82 30,110" fill="rgba(99,102,241,0.30)" stroke="#6366f1"/>
  <polygon points="350,40 210,68 210,82 350,110" fill="rgba(34,197,94,0.30)" stroke="#22c55e"/>
  <circle class="c7-neck" cx="190" cy="75" r="8" fill="#f59e0b" style="animation: c7-ae-pulse 2.5s ease-in-out infinite;"/>
  <text x="174" y="100" fill="#f59e0b">code z</text>
  <circle class="c7-pkt" r="4" fill="#ec4899" style="offset-path: path('M30,75 L190,75 L350,75'); animation: c7-ae-flow 4s linear infinite;"/>
  <text x="34" y="130" fill="currentColor">encoder (squeeze)</text>
  <text x="250" y="130" fill="currentColor">decoder (rebuild)</text>
</svg>
...
::: {.callout-note appearance="simple"}
**↪ The thread continues → [Chapter 08 · 📈 Regression](ch08.html)**
