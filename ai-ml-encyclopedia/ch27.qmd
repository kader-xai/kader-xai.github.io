...
- **Interpretability & Explainability** — SHAP and per-prediction attribution for turning scores into actionable alerts.
...
- **Uncertainty & Calibration** — conformal prediction and distribution-free p-values for turning raw scores into guaranteed error rates.
- **Active Learning** — querying the most informative points to spend a scarce labeling budget where it sharpens the model most.
