...
**The drift workhorse: Population Stability Index (PSI).** PSI measures how far a feature's *current* distribution has slid from a *reference* (training) distribution, by binning both and summing the difference:
