...
ZeRO comes in **three stages**, each sharding one more thing and saving more memory at the cost of a little more communication. The intuition: stage 1 splits up the bulkiest part (optimizer states), stage 2 also splits gradients, and stage 3 splits the parameters themselves (this is what FSDP does).
