...
**Also written:** $\hat{\beta} = X^{+} y$, where $X^{+} = (X^\top X)^{-1}X^\top$ is the **Moore–Penrose pseudoinverse** — the same solution stated as a single projection of $y$ onto the column space of $X$.
