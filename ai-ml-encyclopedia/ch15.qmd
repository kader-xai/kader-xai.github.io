...
<svg viewBox="0 0 520 180" xmlns="http://www.w3.org/2000/svg" font-family="sans-serif" font-size="12">
  <text x="20" y="16" fill="#555">Stacked 3×3 convs widen the receptive field</text>
  <rect x="20" y="30" width="140" height="120" fill="#6366f122" stroke="#6366f1"/>
  <text x="60" y="170" fill="#6366f1">input 7×7</text>
  <rect x="40" y="50" width="100" height="80" fill="#22c55e22" stroke="#22c55e"/>
  <rect x="60" y="70" width="60" height="40" fill="#f59e0b33" stroke="#f59e0b"/>
  <rect x="80" y="86" width="20" height="8" fill="#ec4899" stroke="#ec4899"/>
