---
title: "🔥 Deep Learning with PyTorch · Day 2 — Building Models with nn.Module"
page-layout: full
toc: true
toc-location: left
...
3. `model.state_dict()` serializes everything — which is how saving/loading works on Day 9.
