...
- Achieved **200% of targeted Gross Profit KPIs**; closed high-value mega deals with BSF, CST, and SEC after successful POC implementations.
- Awarded **Infoblox Expert Club Champion (2023)** and **Zscaler ACE (Oct 2024)** for outstanding technical and sales performance.
...
- **CISSP** — ISC2
- **CCSP** — ISC2
- **CCSK V5 + CCZT (Zero Trust)** — Cloud Security Alliance
- **ECPPT V2** — eLearnSecurity
- **DDI Expert + CDAT + CDAC 8.0** — Infoblox
- **AI & Machine Learning Certificate** — Emeritus / IIT Madras Pravartak
- **Trend Micro Tipping Point Expert + Advanced IPS** — Trend Micro
...
| | | |
|---|---|---|
| Multi-Vendor Solution Architecture | DDI (DNS / DHCP / IPAM) | Zero Trust & Cloud Security |
| Presales & RFP Management | Penetration Testing | Secure Network Design |
